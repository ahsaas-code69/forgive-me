...
const timelineData: TimelineItem[] = [
  {
    ...
    description: "Remember how we lost track of time talking about the absolute silliest things? A simple chat that felt like a quiet refuge from the busy world.",
  ...
  },
  {
    ...
    description: "Surrounding ourselves with sweet treats, hand-written notes, and endless laughter. A beautiful day that felt like it belonged entirely to us, celebrating the warmth we share.",
